...
import { Bell, ChevronRight, Clock3, Globe2, Radio, Users } from '@lucide/vue'
import type { ActivityEvent, Friend, VrcNotification, World } from './api'
...
const emit = defineEmits<{ openFriend: [friend: Friend]; selectView: [view: 'friends' | 'worlds' | 'activity' | 'notifications'] }>()
